...
do
    ...
    do
        for workload_name_prefix in 'delay_'
        do
            ...
            python ${base_dir}/${oar_to_jobs_csv} -r ${oar_gant_out} ${real_jobs_csv} \
...
Rscript --vanilla "${base_dir}/${r_aggregated_graph_generator}" \
    "${base_dir}/${aggregated_dir}/delay_results.csv" \
    "${base_dir}/${aggregated_dir}/delay_results.csv" "${aggregated_dir}" \
