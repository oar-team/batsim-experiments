...
do
    ...
    do
        output_filename="g5k_workload_msg_seed${random_seed}_size${platform_size}.json"
        job_number=800
        ...
        python3 json_workload_generator.py -i 4 job_calibration/workload_all_sizes_seq_calibrated.json \
